...
category: skills
tags: [performance, web-vitals, lighthouse, pagespeed, lcp, cls, inp, metrics, speed]
...
Measure, understand, and fix the three metrics Google uses to evaluate real-world user experience: LCP, INP, and CLS.
...
- **Slow server response** — Check TTFB; add caching headers or use a CDN
