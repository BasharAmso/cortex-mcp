...
name: Self-Editing
category: skills
tags: [content-creation, editing, writing-quality, clarity, revision, filler-words, active-voice]
capabilities: [structural-editing, clarity-passes, filler-removal, active-voice-conversion, self-review]
useWhen:
  - revising a draft to make it shorter and clearer
  - feeling like your writing is too wordy or unfocused
  - preparing content for publication after the first draft
  - improving readability without losing your voice
estimatedTokens: 600
relatedFragments: [SKL-0086, SKL-0082, SKL-0033]
dependencies: []
...
### Pass 1: Structure (Does it flow?)

Read the whole piece and ask:

- Does the opening hook earn the next sentence?
- Is there one clear point? Can I state it in one sentence?
- Does every paragraph support that point? (If not, cut it.)
- Does the ending deliver on what the opening promised?

**Action:** Move, merge, or delete entire paragraphs. Don't fix sentences yet.
...
After your first draft, challenge yourself to remove 30% of the word count. This is not about losing ideas. It is about finding the version of each idea that uses the fewest words.

A 300-word post should become 210 words. The cut version will almost always be better.
...
After every paragraph, ask: "So what? Why should the reader care?" If you can't answer in one sentence, that paragraph needs rewriting or cutting.
