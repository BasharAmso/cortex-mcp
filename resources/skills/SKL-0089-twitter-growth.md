...
category: skills
tags: [twitter, x, social-media, content-creation, audience-building, threads, viral-content, engagement]
capabilities: [thread-crafting, reply-strategy, spaces-hosting, viral-mechanics-analysis, twitter-analytics]
useWhen:
  - growing a following on Twitter/X from scratch or a small base
  - crafting threads that get bookmarked and shared
  - developing a reply and quote tweet strategy for visibility
  - planning Twitter Spaces for authority building
  - understanding what makes content go viral on X
estimatedTokens: 700
...
Threads are the highest-leverage format on X. Structure matters:

1. **Hook tweet** -- Must stand alone. Promise a specific outcome or reveal. No "Thread:" label needed
2. **Body tweets** -- One idea per tweet. Use line breaks for readability. 3-5 words per line works
3. **Evidence tweets** -- Screenshots, data, examples. Visual tweets break scroll patterns
4. **CTA tweet** -- Ask for retweet, follow, or bookmark. Be direct
...
- Add a unique take, not just agreement. "This, plus..." is a strong opener
- Quote tweets of viral posts within the first hour get maximum distribution
...
- Promote 24 hours in advance with a pinned tweet
- Record and repurpose highlights as clips
...
|--------|--------|-----------------|
| Bookmarks | Very High | Write save-worthy content (lists, frameworks, resources) |
| Replies | High | Ask questions, make provocative claims |
| Retweets | High | Make content easy to share (complete ideas per tweet) |
| Likes | Medium | Emotional resonance, relatability |
| Dwell time | Medium | Use images, longer tweets, suspense |
| Profile clicks | Medium | Strong hook that makes people curious about you |

## Follower Milestone Tactics

| Stage | Focus | Daily Time |
|-------|-------|------------|
| 0-500 | Replies, networking, finding your voice | 60 min |
| 500-2K | Threads (2/week), consistent posting, niche authority | 45 min |
...
- Your bio is your billboard. Rewrite it every month as your niche sharpens
